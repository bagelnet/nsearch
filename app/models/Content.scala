...
case class Video(contentId: String, title: String, tags: String, viewCounter: Int, mylistCounter: Int, commentCounter: Int, startTime: String, thumbnailUrl: String, lengthSeconds: Int)
